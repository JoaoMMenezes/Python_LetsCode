...
O for se repete uma vez para cada elemento da lista. A cada repetição,
a variável temporária assume o valor de um elemento da lista, na ordem da lista. '''
...
'''
PERCORRENDO SEQUENCIAS NUMÉRICAS
